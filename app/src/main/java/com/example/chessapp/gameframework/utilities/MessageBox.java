package com.example.chessapp.gameframework.utilities;
...
public class MessageBox {
     ...
     */
    public static void popUpMessage(String msg, AppCompatActivity activity) {
    ...
    public static void popUpChoice(String msg, String posButtonText,
                                   ...
                                   OnClickListener negListener, AppCompatActivity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setMessage(msg);
     ...
     *          The current activity. (Nothing will be shown if the activity is null.)
     */
    public static void popUpSaveGame(String msg, final AppCompatActivity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setMessage(msg);
     ...
     *          The current activity. (Nothing will be shown if the activity is null.)
     */
    public static void popUpLoadGame(String msg, final AppCompatActivity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
     ...
     *          The current activity. (Nothing will be shown if the activity is null.)
     */
    public static void popUpDeleteGame(String msg, final AppCompatActivity activity) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        builder.setTitle(msg);
        final CharSequence[] strings = MessageBox.getGameFileNames(activity);
        builder.setItems(strings, new DialogInterface.OnClickListener() {
     ...
     */
    private static CharSequence[] getGameFileNames(AppCompatActivity activity){
